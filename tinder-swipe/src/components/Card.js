...
import '../index.css';
import tagImage from '../icons3/rentC.png'; // Import your tag image here

// Card component with destructured props
const Card = ({ image, index, onCardSwipe, forRent }) => {
  ...
  return (
    ...
    >
      {forRent && <img src={tagImage} alt={`Tag ${index}`} className="tag" />} {/* Conditionally render the tag image */}
    </motion.div>
  );
};
